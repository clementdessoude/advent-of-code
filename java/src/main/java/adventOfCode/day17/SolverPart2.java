...
//            }
    ...
    private Collection<LocationWithDirection> getAdjacentPosition(LocationWithDirection locationWithDirection) {
        ...
        if (location.j() > 0) {
            ...
            if (canTake(currentPath, left, currentDirection, count, Direction.LEFT, locationWithDirection.count())) {
        ...
        if (location.i() > 0) {
            ...
            if (canTake(currentPath, up, currentDirection, count, Direction.UP,
                        locationWithDirection.count()
            )) {
