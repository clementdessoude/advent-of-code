...
class Day18 {
    ...
    int part1(List<String> lines, Pair<Integer, Integer> dimensions, int nanoseconds) {
    ...
    String part2(List<String> lines, Pair<Integer, Integer> dimensions, int nanoseconds) {
